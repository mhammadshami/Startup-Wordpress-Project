...
<div class="container home-page linux-category">
                    ...
                    <div class="main-post">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="post-date"> <i class="fa fa-calendar fa-fw"></i> <?php the_time("F j, Y"); ?>,
                                </span>
    ...
    echo '</div>';
    ?>
    <div class="pagination-numbers" style="height:50"><?php echo numbering_pagination(); ?>
    </div>
</div>
